		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  	...
		  	<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn   buttons-radius features" href="#features" data-transition="<?php echo $transitionefect ?>">Dental Services</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius blog" href="#features" data-transition="<?php echo $transitionefect ?>">Dental Cat Scan Services</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius galery" href="#features" data-transition="<?php echo $transitionefect ?>">About Us</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius aboutus" href="#features" data-transition="<?php echo $transitionefect ?>">Great Views</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius office" href="#features" data-transition="<?php echo $transitionefect ?>">Cape Coral Office</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius office" href="#features" data-transition="<?php echo $transitionefect ?>">Naples Office</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius office" href="#features" data-transition="<?php echo $transitionefect ?>">Ft Myers Office</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius aboutus" href="#features" data-transition="<?php echo $transitionefect ?>">Fun Stories</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius office" href="#features" data-transition="<?php echo $transitionefect ?>">Your Comfort</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius aboutus" href="#features" data-transition="<?php echo $transitionefect ?>">Financing</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn  buttons-radius office" href="#features" data-transition="<?php echo $transitionefect ?>">Future Events</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-features">
						<ul id="menu-features" class="menu-hide">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Dental Services</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Dental Cat Scan Services</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">About US</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Great Views</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Cape Coral Office</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Naples Office</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Ft Myers Office</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Fun Stories</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Your Comfort</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Financing</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Future Events</a></li>
